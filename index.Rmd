...
---
This course is part of the [FAES Graduate School](https://faes.org/content/graduate-school) and is being offered Fall 2016. 
...
legend('topright', legend=levels(iris$Species), pch=1, col=1:3, title='Species')
```
