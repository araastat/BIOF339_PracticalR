...
data_spine <- read.csv('http://www.araastat.com/BIOF339_PracticalR/
                       Lectures/lecture2dataframe_data/Dataset_spine.csv', 
                       stringsAsFactors = F)

data_brca <- read.csv('http://www.araastat.com/BIOF339_PracticalR/
                      Lectures/lecture2dataframe_data/
                      clinical_data_breast_cancer_modified.csv',
                      stringsAsFactors = F)
```

```{r, echo=F}
data_spine <- read.csv('http://www.araastat.com/BIOF339_PracticalR/Lectures/lecture2dataframe_data/Dataset_spine.csv')

data_brca <- read.csv('http://www.araastat.com/BIOF339_PracticalR/Lectures/lecture2dataframe_data/clinical_data_breast_cancer_modified.csv')
