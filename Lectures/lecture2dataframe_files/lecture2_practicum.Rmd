...
```{r, echo=FALSE}
knitr::opts_chunk$set(eval = FALSE, echo = FALSE, results='hide') # Suppress all code and solutions
```


## Read and load a data set in Excel

We will read a breast cancer data set available at  [http://www.araastat.com/BIOF339_PracticalR/Lectures/lecture2_files/BreastCancer.xlsx](http://www.araastat.com/BIOF339_PracticalR/Lectures/lecture2_files/BreastCancer.xlsx). This 
