...
5. Using the "reshape2" or "tidyverse" packages, melt the new single data set so that measured experimental attributes are in a single column.
```{r}
library(reshape2)
