...
<div style = 'height: 40%; position: fixed; bottom: 0;'>

```{r, echo=F}
brca_data  %>% head(3) %>% knitr::kable()
```
...
1. [Introduction to dplyr](https://dplyr.tidyverse.org/articles/dplyr.html)
2. [Tidy data](https://tidyr.tidyverse.org/articles/tidy-data.html)
3. The [paper](http://vita.had.co.nz/papers/tidy-data.html) on tidy data
