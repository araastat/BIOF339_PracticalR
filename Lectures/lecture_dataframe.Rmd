...
or
```{r}
knitr::include_graphics('lecturedataframe_img/install_package.png')
```
...
```{r, echo=F}
knitr::include_graphics('lecturedataframe_img/spreadsheet3.png')
```
...
#
```{r, echo=F}
knitr::include_graphics('lecturedataframe_img/spreadsheet2.png')
```
<div style="font-size:small;text-align:center;">
...
# 
```{r, echo=F}
knitr::include_graphics('lecturedataframe_img/spreadsheet.png')
```
<div style="font-size:small;text-align:center;">
...
# Let's look at a dataset ([Link](Lectures/lecturedataframe_data/Dataset_spine.csv))

```{r}
data_spine <- read.csv('lecturedataframe_data/Dataset_spine.csv')
```
...
```
```{r, echo = FALSE}
knitr::include_graphics('lecturedataframe_img/View.png')
```
